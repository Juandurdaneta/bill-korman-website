...
export default function CoachingIntensive() {
  return (
    <section id="coaching" className="relative py-24 bg-[#0a0a0f] overflow-hidden">
      {/* Background */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1/2 h-[600px] bg-gradient-to-r from-[#1f5f94]/10 to-transparent rounded-r-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#ff8c1a]/10 border border-[#ff8c1a]/30 mb-6">
              <Sparkles className="w-4 h-4 text-[#ff8c1a]" />
              <span className="text-sm text-[#ff8c1a] font-medium">Premium 1:1 Program</span>
            </div>
            ...
            <p className="text-xl text-[#ababbe] mb-8 leading-relaxed">
            ...
            <ul className="space-y-3 mb-8">
              {problems.map((problem, index) => (
                <li key={index} className="flex items-start gap-3 text-[#8686a0]">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="bg-gradient-to-br from-[#1e1e26] to-[#121218] rounded-3xl p-8 md:p-10 border border-[#2a7ab8]/20 relative overflow-hidden">
              {/* Corner accent */}
              ...
              <div className="relative">
                ...
                <p className="text-center text-[#62627d] text-sm">
                  <span className="text-[#ff8c1a] font-semibold">Limited:</span> 3 new clients per quarter
                </p>
              </div>
            </div>
          </motion.div>
