  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0a0a0f]">
        <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-[#1f5f94]/20 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/3 right-1/3 w-96 h-96 bg-[#ff8c1a]/10 rounded-full blur-[120px]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-[#ababbe] text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-[#1f5f94]/20 flex items-center justify-center">
                  <item.icon className="w-6 h-6 text-[#4a9ad8]" />
                </div>
                <div className="text-left">
                  <div className="text-white font-semibold">{item.label}</div>
                  <div className="text-[#8686a0] text-sm">{item.sublabel}</div>
                </div>
              </motion.div>
            ))}
          </div>
