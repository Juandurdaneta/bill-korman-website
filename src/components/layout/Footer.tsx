      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#1f5f94] to-[#2a7ab8] flex items-center justify-center">
            ...
            <p className="text-[#8686a0] text-sm leading-relaxed mb-6">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-[#1e1e26] flex items-center justify-center text-[#8686a0] hover:text-white hover:bg-[#2a7ab8]/20 transition-all duration-300"
                ...
                <li key={link.label}>
                  {link.external ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#8686a0] hover:text-[#4a9ad8] transition-colors text-sm"
                    >
                      {link.label}
                    </a>
                  ) : (
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-[#8686a0] hover:text-[#4a9ad8] transition-colors text-sm"
                >
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            <Link href="/privacy" className="text-[#62627d] hover:text-[#8686a0] transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-[#62627d] hover:text-[#8686a0] transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
